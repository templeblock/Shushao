...
#define PLIMPL_FORWARD_STATIC       class Impl; static Pimpl<Impl> impl;
#define PLIMPL_FORWARD              class Impl; Pimpl<Impl> impl;
#define PLIMPL(CLA)                 CLA::CLA(): impl(spimpl::make_impl<Impl>()) {}
#define PLIMPL_WITH_ARGS(CLA, ...)  CLA::CLA(__VA_ARGS__): impl(spimpl::make_impl<Impl>(__VA_ARGS__)) {}
