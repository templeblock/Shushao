...
void Starship::Awake() {
    ...
    mr->material->SetTexture("diffuse_map", Resources::Get<Texture>("cube_diffuse_brutto"));
    mr->material->SetTexture("specular_map", Resources::Get<Texture>("cube_specular"));
    //mr->material->SetColor("ambient_color", {1.0f, 0.5f, 0.31f});
    //mr->material->SetColor("diffuse_color", {1.0f, 0.5f, 0.31f});
    //mr->material->SetColor("specular_color", {0.5f, 0.5f, 0.5f});
    mr->material->SetFloat("shininess", 32.0f);
